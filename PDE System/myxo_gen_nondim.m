...
save([results_folder '/mean field data kappa = ' num2str(kappa) ', N = ' num2str(Num) '.mat'],'Num','kappa','x','tt','y')


%% plotting

v = VideoWriter([results_folder '/mean field data kappa = ' num2str(kappa) ', N = ' num2str(Num)]);
v.FrameRate = 20;
open(v)
...
savefig([results_folder '/Final and initial profiles kappa = ' num2str(kappa) ' N = ' num2str(Num) '.fig'])
saveas(h,[results_folder '/Final and initial profiles kappa = ' num2str(kappa) ' N = ' num2str(Num) '.png'],'png')
