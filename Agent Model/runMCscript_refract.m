function [] = runMCscript_refract(results_folder)
...
Kappa = 0.001;
N = 2.856e+03;%4570*80;%2.856e+03;%45700; %2000*2;
L = 400;
...
for i = 574:Nruns
    ...
    [params,data,collisions] = alignMC_quasirefractory(i,len,N,L,tend,m,'RaisedWave','Polar',...
        ...
        'yShift',false,'yShift_all',false,'yShift_supp',sqrt(alpha)*10,'NoiseLevel',0,'NoCollisions',false);
